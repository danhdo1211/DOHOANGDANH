...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="http://localhost:8080/DOHOANGDANH/Category/add" class="btn btn-primary rounded-pill"><i class="bi bi-plus-circle-fill me-1"></i>Thêm danh mục</a>
</div>
<div class="table-responsive">
    <table class="table table-hover align-middle shadow-sm" style="border-radius:12px;overflow:hidden">
        ...
        <tr>
            ...
            <td>
                <a href="http://localhost:8080/DOHOANGDANH/Category/edit/<?php echo $cat->id; ?>" class="btn btn-sm btn-outline-warning me-1"><i class="bi bi-pencil"></i> Sửa</a>
                <a href="http://localhost:8080/DOHOANGDANH/Category/delete/<?php echo $cat->id; ?>" onclick="return confirm('Xóa danh mục này?')" class="btn btn-sm btn-outline-danger"><i class="bi bi-trash"></i> Xóa</a>
            </td>
        </tr>
        <?php endforeach; ?>
        </tbody>

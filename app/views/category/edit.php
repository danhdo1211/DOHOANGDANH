...
<div class="row justify-content-center"><div class="col-md-6">
    <div class="card border-0 shadow" style="border-radius:20px;overflow:hidden">
        ...
        <div class="card-body p-4">
            <form method="POST" action="http://localhost:8080/DOHOANGDANH/Category/update">
                ...
                <div class="d-flex gap-2">
                    <a href="http://localhost:8080/DOHOANGDANH/Category/list" class="btn btn-light rounded-3 py-2 flex-fill">Hủy</a>
